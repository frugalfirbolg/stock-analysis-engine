...
def fetch_data(
    ...
    Polygon using an enum or string alias. Returns
    a pandas ``DataFrame`` and only supports
    one ticker at a time.

    Supported enums from: ``analysis_engine.polygon.consts``

    ::

        fetch_type = polygon_consts.FETCH_DAILY
        fetch_type = polygon_consts.FETCH_MINUTE
        fetch_type = polygon_consts.FETCH_QUOTE
        fetch_type = polygon_consts.FETCH_NEWS
        fetch_type = polygon_consts.FETCH_FINANCIALS
        fetch_type = polygon_consts.FETCH_DIVIDENDS
        fetch_type = polygon_consts.FETCH_COMPANY
